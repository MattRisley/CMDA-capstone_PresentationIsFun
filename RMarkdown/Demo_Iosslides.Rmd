---
title: "Iosslides in R Markdown Highlights"
author: "CMDA GTAs"
date: "11/12/2018"
...
# Default (global) Chunk output settings:
knitr::opts_chunk$set(echo = FALSE)

# Recommend installing knitr library:
# library(knitr)
## Here are some other preferences for (global) chunk outputs:
...
Other languages can be accessed from R studio from:

![Example Caption](~/Desktop/python.png)
